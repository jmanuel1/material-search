...
<body>
  <script type="module">import "../../../@polymer/iron-icon/iron-icon.js";
import '@polymer/iron-demo-helpers/demo-snippet.js';
import '@polymer/iron-demo-helpers/demo-pages-shared-styles.js';
import '../iron-iconset.js';
import { html } from "../../../@polymer/polymer/lib/utils/html-tag.js"; // Create this in a module so that the shared styles above are loaded
...
document.body.appendChild(template.content);</script>
  ...
  <div class="centered">
    <h3>Register an icon set</h3>
    <demo-snippet>
      <template>
        <iron-iconset name="my-icons" src="my-icons.png" width="96" size="24" icons="location place starta stopb bus car train walk">
        </iron-iconset>
        <iron-iconset name="my-icons-big" src="my-icons-big.png" width="192" size="48" icons="location place starta stopb bus car train walk">
        </iron-iconset>
      </template>
    </demo-snippet>

    <h3>Small icon set</h3>
    <demo-snippet>
      <template>
    ...
    <h3>Big icon set with labels</h3>
    <demo-snippet>
      <template>
    ...
    <h3>Accessible icon set with labels</h3>
    <demo-snippet>
      <template>
