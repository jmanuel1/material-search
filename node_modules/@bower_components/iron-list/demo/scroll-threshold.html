...
--><!DOCTYPE html><html><head>
  ...
  <dom-module id="x-app">
    <template>
      ...
      <iron-ajax id="ajax" url="https://randomuser.me/api/" params="{&quot;results&quot;: 20}" handle-as="json" loading="{{loadingPeople}}" on-response="_didRespond"></iron-ajax>
      ...
      <iron-scroll-threshold id="scrollTheshold" lower-threshold="500" on-lower-threshold="_load" scroll-target="document"></iron-scroll-threshold>
    </template>
    <script type="module">import "../../../@polymer/polymer/polymer-legacy.js";
...
Polymer({
  ...
  _didRespond: function (e) {
    ...
    }, this); // Clear the lower threshold so we can load more data when the user scrolls
    // down again.
