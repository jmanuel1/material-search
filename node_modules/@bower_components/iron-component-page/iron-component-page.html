...
<dom-module id="iron-component-page">
  ...
  Polymer({
    ...
    observers: ['_updateFrameSrc(view, base)', '_activeChanged(active, _analyzer)'],
    attached: function () {
    ...
    _updateFrameSrc: function (view) {
      ...
      var self = this; // If you use history.pushState with iframe.src = url, you will create 2 history entries,
      ...
      this._iframe.allowFullscreen = true; // Fixes iron-component-page/issues/80
