module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    'closure-compiler': {
      minify: {
        ...
        files: {
          '.tmp/build/axs_testing.js': ['./lib/closure-library/closure/goog/base.js', './src/js/axs.js', './src/js/BrowserUtils.js', './src/js/Constants.js', './src/js/Color.js', './src/js/DOMUtils.js', './src/js/AccessibilityUtils.js', './src/js/Properties.js', './src/js/AuditRule.js', './src/js/AuditRules.js', './src/js/AuditResults.js', './src/js/Audit.js', './src/audits/*']
        },
        options: {
  ...
  grunt.registerTask('gh-release', function () {
    ...
    repo.log = function () {
      grunt.log.writeln.apply(grunt, arguments);
    };
    ...
    repo.getReleaseByName(nextRelease).then(function (release) {
      if (release) {
        if (dryRun) {
  ...
  grunt.registerTask('release', function (releaseType) {
    ...
    tasks = tasks.concat(['test:unit', 'bump-only:' + releaseType, 'changelog:' + releaseType, 'bump-commit', 'coffee:compile', 'gh-release']);
