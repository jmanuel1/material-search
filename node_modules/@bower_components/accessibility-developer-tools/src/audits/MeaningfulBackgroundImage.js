...
axs.AuditRules.addRule({
  ...
  test: function (el) {
    ...
    if (!bgImage || bgImage === 'undefined' || bgImage === 'none' || bgImage.indexOf('url') != 0) {
      return false;
    }

    var width = parseInt(style.width, 10);
    var height = parseInt(style.height, 10); // TODO(bobbrose): could also check for background repeat and position.
