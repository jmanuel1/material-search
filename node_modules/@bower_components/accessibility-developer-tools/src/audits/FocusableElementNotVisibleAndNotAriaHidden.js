...
axs.AuditRules.addRule({
  ...
  relevantElementMatcher: function (element) {
    var isFocusable = axs.browserUtils.matchSelector(element, axs.utils.FOCUSABLE_ELEMENTS_SELECTOR);
    ...
    if (textAlternatives === null || textAlternatives.trim() === '') return false;
    return true;
  },
