...
(function () {
  ...
  function isLayoutTable(element) {
    ...
    if (element.getAttribute('role') == 'presentation') {
      var tableChildren = element.querySelectorAll('*'); // layout tables should only contain TR and TD elements
  ...
  axs.AuditRules.addRule({
    ...
    test: function (element) {
      ...
      return tableDoesNotHaveHeaderRow(rows) && tableDoesNotHaveHeaderColumn(rows) && tableDoesNotHaveGridLayout(rows);
    },
    code: 'AX_TABLE_01'
  });
})();