...
axs.AuditRules.addRule({
  ...
  test: function (element) {
    ...
    if (!elementRole || !elementRole.applied) return false;
    ...
    if (owners) {
      for (var i = 0; i < owners.length; i++) {
        ...
        if (ownerRole && ownerRole.applied && requiredScope.indexOf(ownerRole.applied.name) >= 0) return false; // the owner role is one of the required roles
      }
    }
