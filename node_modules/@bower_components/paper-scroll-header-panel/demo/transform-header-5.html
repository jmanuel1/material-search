...
--><html><head>
  <title>paper-scroll-header-panel: transform header</title>
...
import './sample-content.js';</script>
  ...
  <paper-scroll-header-panel condenses="" keep-condensed-header="" header-height="256" condensed-header-height="140">
    ...
    <paper-toolbar slot="header">
      ...
      <paper-icon-button slot="top" icon="thumb-up"></paper-icon-button>
      <paper-icon-button slot="top" icon="mail"></paper-icon-button>
      <div slot="bottom" class="bottom indent bottom-text" self-end="">
        <div>Lorem ipsum dolor sit amet</div>
        <div class="subtitle">Iisque perfecto dissentiet cum et</div>
      </div>
      <iron-icon slot="bottom" class="bottom bookmark" icon="bookmark"></iron-icon>
