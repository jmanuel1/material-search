...
import { Base } from "../../../@polymer/polymer/polymer-legacy.js"; // toggle fixed header based on screen size
...
panel.fixed = mquery.queryMatches; // custom transformation: scale header's title
