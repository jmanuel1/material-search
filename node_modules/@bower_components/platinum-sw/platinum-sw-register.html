  ...
  Polymer({
    ...
    _constructServiceWorkerUrl: function () {
      ...
      return Promise.all(paramsPromises).then(function (paramsResolutions) {
        ...
        var serviceWorkerUrl = new URL(this.href, window.location); // It's very important to ensure that the serialization is stable.
            ...
            switch (installingWorker.state) {
              case 'installed':
                if (navigator.serviceWorker.controller) {
                  ...
                  this.fire('service-worker-updated', 'A new service worker was installed, replacing the old service worker.');
                } else {
