...
(function () {
  ...
  var contextProps = ['Array', 'Date', 'Function', 'Math', 'Object', 'RegExp', 'String', '_', 'clearTimeout', 'chrome', 'chromium', 'document', 'java', 'navigator', 'phantom', 'platform', 'process', 'runtime', 'setTimeout'];
  ...
  function runInContext(context) {
    ...
    function clock() {
      ...
      } catch (e) {} // Detect Chrome's microsecond timer:
      ...
      timer = _.min(timers, 'res'); // Remove unused applet.
  ...
  if (typeof define == 'function' && typeof define.amd == 'object' && define.amd) {
    ...
    var Benchmark = runInContext(); // Check for `exports` after `define` in case a build optimizer adds an `exports` object.
