...
(function () {
  ...
  var load = typeof require == 'function' && !amd ? require : isJava && root.load || noop;
  /** Load lodash. */
  ...
  var Benchmark = root.Benchmark || (root.Benchmark = (Benchmark = load('../vendor/benchmark.js/benchmark.js') || root.Benchmark, Benchmark = Benchmark.Benchmark || Benchmark, Benchmark.runInContext(lodash.extend({}, root, {
    '_': lodash
  }))));
  /** Load Underscore. */

  var _ = root._ || (root._ = (_ = load('../vendor/underscore/underscore.js') || root._, _._ || _));
  /*--------------------------------------------------------------------------*/
    ...
    'onComplete': function () {
      ...
      if (suites.length) {
        ...
        var aMeanHz = getGeometricMean(score.a),
            ...
            message = 'is ' + percentFaster + '% ' + (xFaster == 1 ? '' : '(' + formatNumber(xFaster.toFixed(2)) + 'x) ') + 'faster than'; // Report results.
  ...
  suites.push(Benchmark.Suite('`_.bindAll` iterating arguments').add(buildName, {
  ...
  suites.push(Benchmark.Suite('`_.bindAll` iterating the `object`').add(buildName, {
  ...
  suites.push(Benchmark.Suite('`_.compose`').add(buildName, {
  ...
  suites.push(Benchmark.Suite('`_.each` iterating an array with `thisArg` (slow path)').add(buildName, '\
        var result = [];\
        lodash.each(numbers, function(num, index) {\
          result.push(num + this["key" + index]);\
        }, object)').add(otherName, '\
        var result = [];\
  ...
  suites.push(Benchmark.Suite('`_.filter` iterating an array with `thisArg` (slow path)').add(buildName, '\
  ...
  suites.push(Benchmark.Suite('`_.flatten` nested arrays of numbers with `isDeep`').add(buildName, {
    'fn': 'lodash.flatten(nestedNumbers, lodashFlattenDeep)',
    'teardown': 'function flatten(){}'
  }).add(otherName, {
    'fn': '_.flatten(nestedNumbers, _flattenDeep)',
  ...
  suites.push(Benchmark.Suite('`_.flatten` nest arrays of objects with `isDeep`').add(buildName, {
  ...
  if (lodash.include('ab', 'ab') && _.include('ab', 'ab')) {
    suites.push(Benchmark.Suite('`_.includes` searching a string').add(buildName, '\
          lodash.include(strNumbers, "," + (limit - 1))').add(otherName, '\
          _.include(strNumbers, "," + (limit - 1))'));
  }
  /*--------------------------------------------------------------------------*/


  suites.push(Benchmark.Suite('`_.indexBy` with `callback` iterating an array').add(buildName, '\
        lodash.indexBy(numbers, function(num) { return num >> 1; })').add(otherName, '\
        _.indexBy(numbers, function(num) { return num >> 1; })'));
  suites.push(Benchmark.Suite('`_.indexBy` with `property` name iterating an array').add(buildName, {
  ...
  suites.push(Benchmark.Suite('`_.indexBy` with `callback` iterating an object').add(buildName, {
  ...
  suites.push(Benchmark.Suite('`_.indexOf` performing a binary search').add(buildName, {
  ...
  suites.push(Benchmark.Suite('`_.invoke` iterating an array').add(buildName, '\
        lodash.invoke(numbers, "toFixed")').add(otherName, '\
        _.invoke(numbers, "toFixed")'));
  suites.push(Benchmark.Suite('`_.invoke` with arguments iterating an array').add(buildName, '\
        lodash.invoke(numbers, "toFixed", 1)').add(otherName, '\
        _.invoke(numbers, "toFixed", 1)'));
  suites.push(Benchmark.Suite('`_.invoke` with a function for `path` iterating an array').add(buildName, '\
        lodash.invoke(numbers, Number.prototype.toFixed, 1)').add(otherName, '\
        _.invoke(numbers, Number.prototype.toFixed, 1)'));
  suites.push(Benchmark.Suite('`_.invoke` iterating an object').add(buildName, '\
        lodash.invoke(object, "toFixed", 1)').add(otherName, '\
  ...
  suites.push(Benchmark.Suite('`_.lastIndexOf` performing a binary search').add(buildName, {
  ...
  suites.push(Benchmark.Suite('`_.map` with `thisArg` iterating an array (slow path)').add(buildName, '\
  ...
  suites.push(Benchmark.Suite('`_.pairs`').add(buildName, '\
        lodash.pairs(object)').add(otherName, '\
        _.pairs(object)'));
  /*--------------------------------------------------------------------------*/
  ...
  suites.push(Benchmark.Suite('`_.partition` iterating an array with `thisArg` (slow path)').add(buildName, '\
  ...
  suites.push(Benchmark.Suite('`_.pluck`').add(buildName, '\
        lodash.pluck(objects, "num")').add(otherName, '\
        _.pluck(objects, "num")'));
  /*--------------------------------------------------------------------------*/
  ...
  suites.push(Benchmark.Suite('`_.reject` iterating an array with `thisArg` (slow path)').add(buildName, '\
  ...
  suites.push(Benchmark.Suite('`_.sample` with an `n`').add(buildName, '\
        lodash.sample(numbers, limit / 2)').add(otherName, '\
  ...
  suites.push(Benchmark.Suite('`_.some` with `thisArg` iterating an array (slow path)').add(buildName, '\
  ...
  suites.push(Benchmark.Suite('`_.sortBy` with `callback` and `thisArg` (slow path)').add(buildName, '\
        lodash.sortBy(numbers, function(num) { return this.sin(num); }, Math)').add(otherName, '\
  ...
  suites.push(Benchmark.Suite('`_.sortedIndex` with `callback`').add(buildName, {
    'fn': '\
  ...
  suites.push(Benchmark.Suite('`_.times` with `thisArg` (slow path)').add(buildName, '\
        var result = [];\
        lodash.times(limit, function(n) { result.push(this.sin(n)); }, Math)').add(otherName, '\
        var result = [];\
  ...
  suites.push(Benchmark.Suite('`_.uniq` with `callback`').add(buildName, '\
  ...
  suites.push(Benchmark.Suite('`_.where`').add(buildName, {
