...
--><html><head>
  ...
  <body>
    ...
    <div class="vertical-section vertical-section-container centered">
      ...
      <dom-bind>
        <template is="dom-bind">
          <h3>Good loader</h3>
          <iron-jsonp-library library-url="https://apis.google.com/js/plusone.js?onload=%%callback%%" notify-event="api-load" library-loaded="{{loaded}}" library-error-message="{{errorMessage}}">
          </iron-jsonp-library>
      ...
      <dom-bind>
        <template is="dom-bind">
          <h3>Bad loader</h3>
          <iron-jsonp-library library-url="https://badapis.google.com/js/plusone.js?onload=%%callback%%" notify-event="api-load" library-loaded="{{loaded}}" library-error-message="{{errorMessage}}">
          </iron-jsonp-library>
          <template is="dom-if" if="{{loaded}}">
    ...
    <script type="module">import "../../../@polymer/paper-styles/color.js";
import "../../../@polymer/paper-styles/demo-pages.js";
import "../../../@polymer/paper-spinner/paper-spinner.js";
import '../iron-jsonp-library.js';
import { PolymerElement } from "../../../@polymer/polymer/polymer-element.js"; // kick off delayed loader by setting libraryUrl

window.setTimeout(function () {
  document.querySelector('#delayedLoader').libraryUrl = 'https://apis.google.com/js/drive-realtime.js?onload=%%callback%%';
}, 1000);</script>
