...
helpers.debug('Service Worker Toolbox is loading'); // Install
...
self.addEventListener('install', function (event) {
  ...
  event.waitUntil(helpers.openCache({
    cacheName: inactiveCache
  }).then(function (cache) {
    return Promise.all(options.preCacheItems).then(flatten).then(function (preCacheItems) {
