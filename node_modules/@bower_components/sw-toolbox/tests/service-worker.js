...
toolbox.router.get('fixtures/:foo', toolbox.cacheOnly); // Single item

toolbox.precache('fixtures/a'); // Array of items

toolbox.precache(['fixtures/b', 'fixtures/c']); // Array of Promises

toolbox.precache([Promise.resolve('fixtures/d'), Promise.resolve('fixtures/e')]); // Array of Arrays

toolbox.precache(['fixtures/f', ['fixtures/g', 'fixtures/h'], ['fixtures/i', 'fixtures/j']]); // Array of Promises for Arrays
