...
<script>Polymer({
  ...
  requery: function () {
    // shut-down previous observers (if any)
    this.closeQuery();
    this.closeObserver(); // construct new query
  ...
  queryChanged: function () {
    // initialize
    this._updateData(null); // data acquisition
  ...
  //
  observeData: function () {// if (this.data instanceof Array) {
  ...
  closeObserver: function () {// if (this.observer) {
    //   this.observer.close();
    //   this.observer = null;
    // }
  },
  ...
  modulateData: function (operation, snapshot) {
    ...
    this.dataChange(); // discard any observations so we don't send this value back to the
