...
<body unresolved="">
  ...
  <div class="vertical-section-container centered">
    <h3>
      <code>&lt;iron-pages&gt;</code> inherits functionality (for example,
      <code>attr-for-selected</code>) from
      <code>IronSelectableBehavior</code>.
    </h3>
    <demo-snippet>
      <template>
        <custom-style>
        ...
        <dom-bind>
          <template is="dom-bind">
            ...
            <iron-pages selected="[[pageName]]" attr-for-selected="page-name" fallback-selection="fallback">
              <div page-name="page-1">One</div>
              <div page-name="page-2">Two</div>
              <div page-name="page-3">Three</div>
