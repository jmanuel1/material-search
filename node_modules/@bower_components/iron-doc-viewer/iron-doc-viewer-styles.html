  ...
  <template>
    <style>
      :host {
        ...
        color: var(--iron-doc-viewer-text-color, var(--paper-grey-900));
        display: block;
      }
      ...
      .deeplink:hover {
        color: var(--iron-doc-viewer-title-link-hover, var(--paper-pink-500));
      }
      ...
      #api a {
        ...
        color: var(--iron-doc-viewer-api-link-color, var(--paper-grey-800));
        cursor: pointer;
        display: block;
        padding: 4px 16px;
      }
      ...
      #summary .markdown-html pre {
        background-color: var(--iron-doc-viewer-markdown-background, var(--paper-grey-200));
        border-radius: 3px;
        font-size: 15px;
        overflow-x: auto;
        padding: 12px 24px;
      ...
      #summary .markdown-html code {
        ...
        background: var(--iron-doc-viewer-markdown-background, var(--paper-grey-200));
        padding: 3px;
        border-radius: 3px;
      }
      ...
      #summary .markdown-html a {
        background: none;
        @apply --paper-font-body1;
        color: var(--iron-doc-viewer-summary-link-color, var(--paper-indigo-a200));
        font-weight: 500;
        text-decoration: none;
      }
      ...
      nav {
        border-bottom: 1px solid var(--iron-doc-viewer-nav-border, var(--paper-grey-200));
      }

      iron-doc-property {
        background: var(--iron-doc-viewer-property-background, var(--paper-grey-200));
      }
      ...
      :host(.show-private) iron-doc-property[private] {
        display: block;
        background: var(--iron-doc-viewer-private-property-background, var(--paper-grey-300));
      }
      ...
      paper-button:hover {
        color: var(--iron-doc-viewer-button-hover, var(--paper-pink-500));
      }
    </style>
  </template>
</dom-module>
