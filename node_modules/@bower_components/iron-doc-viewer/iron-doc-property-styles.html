...
<dom-module id="iron-doc-property-styles">
  <template>
    <style>
      ...
      .deeplink:hover {
        color: var(--iron-doc-viewer-property-deeplink-color-hover, var(--paper-pink-500));
      }
      ...
      .annotation {
        color: var(--iron-doc-viewer-property-annotation-color, var(--paper-grey-700));
        float: right;
      }
      ...
      #default .value {
        color: var(--iron-doc-viewer-property-default-value-color, var(--paper-grey-500));
        font-size: 12px;
      }
      ...
      #desc .markdown-html a {
        color: var(--iron-doc-viewer-property-markdown-link-color, var(--paper-indigo-200));
        text-decoration: none;
      }
      ...
      #meta {
        ...
        color: var(--iron-doc-viewer-property-meta-color, var(--paper-blue-500));
      }
      #desc {
