...
<dom-module id="iron-doc-property">
  ...
  Polymer({
    ...
    _collapsedChanged: function () {
      ...
      var collapsed = this.collapsed; // Measure `height: auto`, which we will need regardless of transition
      ...
      var fullHeight = container.offsetHeight; // Then, we reset to the start state. Changing directions mid-transition
      // is _not_ supported!
