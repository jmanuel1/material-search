...
page.base('/profile');
page('/', index); // display the index page again after 5s
// only for user related pages

page('/user/*', displayIndexAfter(5000)); // you dont need to use two,
...
page('/user/:name', load);
page('/user/:name', show); // or:
// page('/user/:name', load, show);

page('*', notfound);
page(); // everything below is not part of page.js
// just callbacks etc..
