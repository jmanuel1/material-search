...
describe('test all the things', () => {
  ...
  describe('outputs the correct values', () => {
    it('when called without args', () => {
      ...
      expect(global.console.log).toHaveBeenNthCalledWith(1, `\u001b[96m\u001b[1mThank you for using testpkg2!\u001b[96m\u001b[1m`);
