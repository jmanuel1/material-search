      ...
      for (var n in o) {
        ...
        if (r.language && l[r.language] && !l[r.language].initialized) {
          ...
          Array.isArray(e) || (e = [e]), e.forEach(function (e) {
            var s, i, t, a;
            e = (!0 === e ? (s = "important", i = r.language) : (s = e.before || "important", i = e.inside || e.lang, t = e.root || Prism.languages, a = e.skip), r.language), !a && Prism.languages[e] && (Prism.languages.insertBefore(i, s, o[n].tokens, t), r.grammar = Prism.languages[e], l[r.language] = {
              initialized: !0
            });
          });
        }
