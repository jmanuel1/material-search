...
var exclusions = ['--help']; // This number must be incremented whenever the generated cache file changes.
...
function getFlags(cb) {
  execFile(process.execPath, ['--v8-options'], function (execErr, result) {
    ...
    var flags = matchedFlags.map(normalizeFlagName).filter(function (name) {
