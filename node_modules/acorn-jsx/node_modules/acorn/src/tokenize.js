...
import { lineBreak, lineBreakG, isNewLine, nonASCIIwhitespace } from "./whitespace.js"; // Object type used to represent tokens. Note that normally, tokens
...
const pp = Parser.prototype; // Are we running under Rhino?

const isRhino = typeof Packages == "object" && Object.prototype.toString.call(Packages) == "[object JavaPackage]"; // Move to the next token
...
pp.readToken_mult_modulo_exp = function (code) {
  ...
  let next = this.input.charCodeAt(this.pos + 1);
  let size = 1;
  let tokentype = code === 42 ? tt.star : tt.modulo; // exponentiation operator ** and **=
...
pp.readRegexp = function () {
  ...
  let value = null; // Rhino's regular expression parser is flaky and throws uncatchable exceptions,
