  ...
  var H = new T({
    ...
    return n(t, [{
      ...
      value: function (t, e) {
        ...
        for (e ? (a = e.loc.end.line - 1, n = e.loc.end.column) : (a = t.loc.end.line - 1, n = t.loc.end.column); s < a;) s++, r = this.source[s], s === i ? i === a ? l.push(r.slice(o, n)) : l.push(r.slice(o)) : s === a ? l.push(r.slice(0, n)) : l.push(r);
  ...
  var xt = yt(function (t, r) {
    ...
    r.default = function (t) {
      t.registerHelper("each", function (t, r) {
        ...
        if (r.data && r.ids && (c = kt.appendContextPath(r.data.contextPath, r.ids[0]) + "."), kt.isFunction(t) && (t = t.call(this)), r.data && (l = kt.createFrame(r.data)), t && "object" === e(t)) if (kt.isArray(t)) for (var h = t.length; s < h; s++) s in t && u(s, s, s === t.length - 1);else {
          var p = void 0;
  ...
  var At = yt(function (t, e) {
    e.__esModule = !0, e.default = function (t) {
      t.registerHelper("log", function () {
        for (var e = [void 0], r = arguments[arguments.length - 1], a = 0; a < arguments.length - 1; a++) e.push(arguments[a]);
  ...
  var Tt = yt(function (t, e) {
    e.__esModule = !0, e.default = function (t) {
      t.registerDecorator("inline", function (t, e, r, a) {
        var n = t;
        return e.partials || (e.partials = {}, n = function (a, n) {
          var i = r.partials;
    ...
    r.__esModule = !0, r.checkRevision = function (t) {
      ...
      var a = {
        ...
        invokePartial: function (e, a, s) {
          ...
          if (null != o) {
            if (s.indent) {
              for (var l = o.split("\n"), c = 0, u = l.length; c < u && (l[c] || c + 1 !== u); c++) l[c] = s.indent + l[c];
        ...
        parse: function (t) {
          ...
          for (var p, f, d, m, g, v, b, y, k, S, w = {};;) {
            if (d = r[r.length - 1], this.defaultActions[d] ? m = this.defaultActions[d] : (null !== p && void 0 !== p || (S = void 0, "number" != typeof (S = e.lexer.lex() || 1) && (S = e.symbols_[S] || S), p = S), m = i[d] && i[d][p]), void 0 === m || !m.length || !m[0]) {
              ...
              if (!c) {
                for (v in k = [], i[d]) this.terminals_[v] && v > 2 && k.push("'" + this.terminals_[v] + "'");
    ...
    s.prototype = {
      ...
      compile: function (t, e) {
        ...
        if (e.knownHelpers = {
          ...
          log: !0,
          lookup: !0
        }, r) for (var a in r) this.options.knownHelpers[a] = r[a];
  ...
  var Gt = yt(function (t, e) {
    ...
    s.prototype = {
      ...
      compile: function (t, e, r, n) {
        ...
        for (l = 0, c = i.length; l < c; l++) s = i[l], this.source.currentLocation = s.loc, o = o || s.loc, this[s.opcode].apply(this, s.args);
        ...
        for (l = 0, c = f.length; l < c; l++) f[l] && (h[l] = f[l], d[l] && (h[l + "_d"] = d[l], h.useDecorators = !0));
      ...
      resolvePath: function (t, e, r, a, n) {
        ...
        }(this.options.strict && n, this, e, t));else for (var s = e.length; r < s; r++) this.replaceStack(function (n) {
      ...
      setupParams: function (t, e, r) {
        ...
        for (var h = e; h--;) l = this.popStack(), r[h] = l, this.trackIds && (s[h] = this.popStack()), this.stringParams && (i[h] = this.popStack(), n[h] = this.popStack());
      ...
      for (var t = "break else new var case finally return void catch for switch while continue function this with default if throw delete in try do instanceof typeof abstract enum int short boolean export interface static byte extends long super char final native synchronized class float package throws const goto private transient debugger implements protected volatile double import public let yield await null true false".split(" "), e = s.RESERVED_WORDS = {}, r = 0, a = t.length; r < a; r++) e[t[r]] = !0;
