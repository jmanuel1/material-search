  ...
  var V = function (t, e) {
    ...
    var K = function (t) {
      ...
      return s.addComment = function (t) {
        ...
        if (!("Program" === t.type && t.body.length > 0)) {
          ...
          for (n.length > 0 && W(n).start >= t.start && (e = n.pop()); n.length > 0 && W(n).start >= t.start;) s = n.pop();
          ...
          if (s) {
            if (s.leadingComments) if (s !== t && s.leadingComments.length > 0 && W(s.leadingComments).end <= t.start) t.leadingComments = s.leadingComments, delete s.leadingComments;else for (r = s.leadingComments.length - 2; r >= 0; --r) if (s.leadingComments[r].end <= t.start) {
    ...
    var z = function (t) {
      ...
      return s.next = function () {
        ...
        for (-1 === i && this.raise(this.state.pos - 2, "Unterminated comment"), this.state.pos = i + 2, l.lastIndex = s; (t = l.exec(this.input)) && t.index < this.state.pos;) ++this.state.curLine, this.state.lineStart = t.index + t[0].length;
        ...
        if (this.state.pos < this.input.length) for (; 10 !== i && 13 !== i && 8232 !== i && 8233 !== i && ++this.state.pos < this.input.length;) i = this.input.charCodeAt(this.state.pos);
      ...
      return s.parseTopLevel = function (t, e) {
        ...
        for (this.expect(h.braceL), this.state.labels.push(tt); !this.match(h.braceR);) if (this.match(h._case) || this.match(h._default)) {
        ...
        a.body = [], this.expect(h.braceL), this.withTopicForbiddingContext(function () {
          for (; !e.eat(h.braceR);) if (e.eat(h.semi)) r.length > 0 && e.raise(e.state.lastTokEnd, "Decorators must not be followed by a semicolon");else if (e.match(h.at)) r.push(e.parseDecorator());else {
            var t = e.startNode();
      ...
      return s.checkPropClash = function (t, e) {
        ...
        for (var n = null; !this.eat(h.braceR);) {
          ...
          if (this.match(h.at)) if (this.hasPlugin("decorators")) this.raise(this.state.start, "Stage 2 decorators disallow object literal property decorators");else for (; this.match(h.at);) s.push(this.parseDecorator());
      ...
      return s.toAssignable = function (t, e, s) {
        ...
        for (var i = [], r = !0; !this.eat(t);) if (r ? r = !1 : this.expect(h.comma), e && this.match(h.comma)) i.push(null);else {
          if (this.eat(t)) break;
          ...
          for (this.match(h.at) && this.hasPlugin("decorators") && this.raise(this.state.start, "Stage 2 decorators cannot be used to decorate parameters"); this.match(h.at);) n.push(this.parseDecorator());
      ...
      jsx: function (t) {
        return function (t) {
          ...
          return s.jsxReadToken = function () {
            ...
            for (var e = []; !this.match(h.slash) && !this.match(h.jsxTagEnd);) e.push(this.jsxParseAttribute());
      ...
      flow: function (t) {
        return function (t) {
          ...
          return s.shouldParseTypes = function () {
            ...
            for (this.state.noAnonFunctionType = !1; !this.isRelational(">");) t.params.push(this.flowParseType()), this.isRelational(">") || this.expect(h.comma);
            ...
            for (t.params = [], this.state.inType = !0, this.expectRelational("<"); !this.isRelational(">");) t.params.push(this.flowParseTypeOrImplicitInstantiation()), this.isRelational(">") || this.expect(h.comma);
      ...
      typescript: function (t) {
        return function (t) {
          ...
          return s.tsIsIdentifier = function () {
            ...
            for (var t = this.tsParseNonArrayType(); !this.hasPrecedingLineBreak() && this.eat(h.bracketL);) if (this.match(h.bracketR)) {
              var e = this.startNodeAtNode(t);
            ...
            if (this.match(h.braceL)) {
              ...
              for (this.next(); t > 0;) this.match(h.braceL) ? ++t : this.match(h.braceR) && --t, this.next();
