...
const prettyQuickResult = prettyQuick(process.cwd(), Object.assign({}, args, {
...
if (prettyQuickResult.success) {
  ...
  if (prettyQuickResult.errors.indexOf('PARTIALLY_STAGED_FILE') !== -1) {
    console.log('✗ Partially staged files were fixed up.' + ` ${chalk.bold('Please update stage before committing')}.`);
  }
